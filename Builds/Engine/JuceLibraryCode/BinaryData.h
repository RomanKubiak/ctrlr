...
namespace BinaryData
{
    ...
    const int            CtrlrRevision_templateSize = 244;
    ...
    const int            ico_folder_pngSize = 3221;
    ...
    const int            ico_midi_pngSize = 3764;

    extern const char*   ico_midi_small_png;
    const int            ico_midi_small_pngSize = 3381;
    ...
    extern const char*   ico_variation_png;
    const int            ico_variation_pngSize = 3470;

    extern const char*   ico_waveform_png;
    const int            ico_waveform_pngSize = 707;
    ...
    const int            CtrlrIDs_xmlSize = 69315;

    extern const char*   CtrlrLuaMethodTemplates_xml;
    const int            CtrlrLuaMethodTemplates_xmlSize = 12976;
    ...
    const int            CtrlrMIDIVendors_xmlSize = 15062;
