...
ctrlr - program to do something

# SYNOPSIS

**ctrlr** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ctrlr** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ctrlr** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**ctrlr** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    ctrlr. See **foo.conf**(5) for further details.
...
**ctrlr** provides some return codes, that can be used in scripts:
...
Tobias Schlemmer <tobias@tobias4.schlemmersoft.de>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Tobias Schlemmer
