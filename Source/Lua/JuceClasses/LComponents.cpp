...
void LPopupMenu::wrapForLua (lua_State *L)
{
    ...
    [
		...
		class_<LPopupMenu, bases<PopupMenu> >("PopupMenu")
				...
				.def("addColouredItem", (void(PopupMenu::*)(int, const String&, Colour, bool, bool, Drawable *))&PopupMenu::addColouredItem)
				.def("addColouredItem", (void(PopupMenu::*)(int, const String&, Colour, bool, bool, const Image &))&PopupMenu::addColouredItem)
