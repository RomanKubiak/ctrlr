...
void LAudioSampleBuffer::wrapForLua (lua_State *L)
{
    ...
    [
		class_<AudioSampleBuffer>("AudioSampleBuffer")
				...
				.def("getSampleData", (float *(AudioSampleBuffer::*)(const int) const noexcept)&AudioSampleBuffer::getSampleData)
				.def("getSampleData", (float *(AudioSampleBuffer::*)(const int,const int) const noexcept)&AudioSampleBuffer::getSampleData)
				.def("getArrayOfChannels", &AudioSampleBuffer::getArrayOfChannels)
