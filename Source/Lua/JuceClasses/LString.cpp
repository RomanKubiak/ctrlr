...
void LString::wrapForLua (lua_State *L)
{
    ...
    [
		class_<String>("String")
			...
			//.def("indexOf", (int (String::*)(const String &) const) &String::indexOf)
			//.def("indexOf", (int (String::*)(const int, const String &) const) &String::indexOf)
			//.def("indexOfIgnoreCase", (int (String::*)(const String &) const) &String::indexOfIgnoreCase)
			//.def("indexOfIgnoreCase", (int (String::*)(const int, const String &) const) &String::indexOfIgnoreCase)
		...
		class_<StringArray>("StringArray")
			...
			//.def("addTokens", (int (StringArray::*)(const String &, bool)) &StringArray::addTokens)
			//.def("addTokens", (int (StringArray::*)(const String &, const String &, const String &)) &StringArray::addTokens)
