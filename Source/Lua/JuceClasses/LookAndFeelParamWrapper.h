...
struct LookAndFeelParamWrapper
{
	...
	float minSliderPos = 0.0f;
	float maxSliderPos = 0.0f;
	float imageOpacity = 0.0f;
	float level = 0.0f;
	float sliderPosProportional = 0.0f, rotaryStartAngle = 0.0f, rotaryEndAngle = 0.0f;
	...
	bool drawTitleTextOnLeft = false;
	bool positionTitleBarButtonsOnLeft = false;
	...
	const Colour *backgroundColourRef = nullptr;
	const Colour *colourRef = nullptr;
	const Colour *textColourPtr = nullptr;
	const Colour *overlayColourRef = nullptr;
	bool isItemSelected = false;
	const String *keyDescription  = nullptr;
	const String *name = nullptr;
	const String *text = nullptr;
	const String *title = nullptr;
	const String *message = nullptr;
	const String *button1 = nullptr;
	const String *button2 = nullptr;
	const String *button3 = nullptr;
	const String *instructions = nullptr;
	const String *filename = nullptr;
	const String *shortcutKeyText = nullptr;
	const String *itemText = nullptr;
	const String *tipText = nullptr;
	const String *columnName = nullptr;
	const String *textToShow = nullptr;
	const String *fileSizeDescription = nullptr;
	const String *fileTimeDescription = nullptr;
	const Image *icon = nullptr;
	Image *image = nullptr;
	const Drawable *drawableIcon = nullptr;
	Slider *slider = nullptr;
	AlertWindow::AlertIconType iconType;
	Component *associatedComponent = nullptr;
	AlertWindow *window = nullptr;
	const Rectangle<int> *textArea;
	TextLayout *layout = nullptr;
	ProgressBar *progressBar = nullptr;
	ScrollBar *scrollBar = nullptr;
	const Rectangle<float> *area = nullptr;
	Rectangle<int> *areaInt = nullptr;
	Rectangle<int> *menuItemArea = nullptr;
	const Rectangle<int> *areaIntConst = nullptr;
	TextEditor *textEditor = nullptr, *editor = nullptr;
	Component *keyFocusOwner = nullptr;
	DirectoryContentsDisplayComponent *directoryContentsDisplayComponent = nullptr;
	FileBrowserComponent *fileBrowserComponent = nullptr;
	FilePreviewComponent *filePreviewComponent = nullptr;
	ComboBox *currentPathBox = nullptr;
	TextEditor *filenameBox = nullptr;
	Button *goUpButton = nullptr;
	BubbleComponent *bubble = nullptr, *bubbleComponent = nullptr;
	const Point<float> *tip = nullptr;
	const Rectangle<float> *body = nullptr;
	MenuBarComponent *menuBarComponent = nullptr;
	ComboBox *comboBox = nullptr;
	Label *label = nullptr;
	Slider::SliderStyle sliderStyle;
	FilenameComponent *filenameComponent = nullptr;
	ConcertinaPanel *concertinaPanel = nullptr;
	const BorderSize<int> *borderSize = nullptr;
	ResizableWindow *resizableWindow = nullptr;
	DocumentWindow *documentWindow = nullptr;
	Button *minimiseButton = nullptr;
	Button *maximiseButton = nullptr;
	Button *closeButton = nullptr;
	const Justification *justification = nullptr;
	GroupComponent *groupComponent = nullptr;
	TabBarButton *tabBarButton = nullptr;
	const TabBarButton *tabBarButtonConst = nullptr;
	TabbedButtonBar *tabbedButtonBar = nullptr;
	Path *p = nullptr;
	const Path *path = nullptr;
	TableHeaderComponent *tableHeaderComponent = nullptr;
	Toolbar *toolbar = nullptr;
	ToolbarItemComponent *toolbarItemComponent = nullptr;
	PropertyComponent *propertyComponent = nullptr;
	CallOutBox *callOutBox = nullptr;
    /* MEMBERS END */
	...
	LookAndFeelParamWrapper (Graphics &g_, const Rectangle<int> &menuItemArea_, bool isSeparator_, bool isActive_, bool isHighlighted_, bool isTicked_, bool hasSubMenu_, const String &text_, const String &shortcutKeyText_, const Drawable* drawableIcon_, const Colour *textColourPtr_) : g(&g_), menuItemArea(&menuItemArea_), isSeparator(isSeparator_), isActive(isActive_), isHighlighted(isHighlighted_), isTicked(isTicked_), hasSubMenu(hasSubMenu_), text(&text_), shortcutKeyText(&shortcutKeyText_), drawableIcon(drawableIcon_), textColourPtr(textColourPtr_) { }
	...
	static void wrapForLua (lua_State *L)
	{
		...
		[
			class_<LookAndFeelParamWrapper>("LookAndFeelParamWrapper")
				...
				.def_readonly ("menuItemArea", &LookAndFeelParamWrapper::menuItemArea)
