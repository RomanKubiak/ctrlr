...
#ifndef __VIEWPORTEXT_H__
#define __VIEWPORTEXT_H__
...
*/
class ViewportExt  : public Component,
...
public:
    ...
    */
    explicit ViewportExt (const String& componentName = String::empty);
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ViewportExt);
};
