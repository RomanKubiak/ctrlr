...
class CtrlrMIDILibraryRequest
{
	public:
		...
		bool operator== (const CtrlrMIDILibraryRequest& other) const noexcept;
		...
		int getExpectedPrefixSize() const;
		...
		CtrlrMIDILibraryAction getCurrentAction() const;
		void setNextAction(const CtrlrMIDILibraryAction _nextAction);
		CtrlrMIDILibraryAction getNextAction() const;
		...
		CtrlrMIDILibraryStatus getStatus() const;
		...
		bool getMatchSize() const;
		void setMatchPrefix(const bool _matchPrefix);
		bool getMatchPrefix() const;
		int getCustomRequestIndex() const;
