...
class CtrlrSysexProcessor
{
	public:
		...
		virtual const double getValueFromSysExData (const Array<CtrlrSysexToken> &tokens, const CtrlrMidiMessageEx &message);
		...
		static const CtrlrMidiMessageEx sysexMessageFromString (const String &formula, const int value, const int channel);
