...
CtrlrMidiMessageType getMidiTypeFromModulator(CtrlrModulator *m, const int index=-1, CtrlrMIDIDeviceType source = CtrlrMIDIDeviceType::inputDevice);
...
int getMidiNumberFromModulator(CtrlrModulator *m, const CtrlrMIDIDeviceType source = CtrlrMIDIDeviceType::inputDevice);
